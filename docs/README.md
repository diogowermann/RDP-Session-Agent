...
- [Phase 9 Windows rollout](phase9-windows-rollout.md) — credential-safe runtime update, zero-dependency native PowerShell self-test, per-server canary checks, rollback evidence and controlled batch expansion.
